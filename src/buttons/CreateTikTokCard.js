    ...
    const createTikTokProfileCard = () => {
        ...
        localUserPage.cards[uid] =
        {
            ...
            details:{
                ...
                url: "http://www.tiktok.com/@" + profileUsername
            }
        }
    ...
    return (
        ...
        <Dialog centered open={show} onClose={handleClose}>
            ...
            <DialogActions>
                ...
                <Button onClick={() => {socialOption == 'profile' ? (createTikTokProfileCard()):(createTikTokPostCard())}} style={{backgroundColor:'#4169e1', color:'white'}}>Add</Button>
            </DialogActions>
        </Dialog>
        <Button onClick={() => handleShow()} style={{marginBottom: 10, backgroundColor:'black', color:'white'}} variant="contained" startIcon={<SiTiktok />}>Tik Tok</Button>
        </>
    )
}

export default CreateTikTokCard
